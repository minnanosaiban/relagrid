...
アプリ右上の「? 構文ヘルプ」を開くと、Claude用のプロンプトがコピーできます。
手順は次のとおりです。

1. プロンプトをコピーし、「【内容】」の下に作りたい関係図の説明を書き足してからClaudeに送る
2. Claudeが返したDSLコード（&#96;&#96;&#96;で囲まれた部分）をコピーする
3. アプリ左側の「テキスト (DSL)」欄に貼り付ける（図がその場で描画される）

プロンプトにはDSL構文をすべて含めているので、Claudeがこのサイトを閲覧できなくても
